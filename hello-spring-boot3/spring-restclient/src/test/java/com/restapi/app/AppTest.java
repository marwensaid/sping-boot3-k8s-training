...
public class AppTest {
  ...
  public void testGetAll() {
    ...
    List<com.restapi.app.model.Employee> employeeList = restClient.get()
        .uri("/employees")
  ...
  public void testGetById() {
    ...
    com.restapi.app.model.Employee employee = restClient.get()
        .uri("/employees/1")
        .accept(MediaType.APPLICATION_JSON)
        .retrieve()
        .body(com.restapi.app.model.Employee.class);
  ...
  public void testPostAndDelete() {
    ...
    com.restapi.app.model.Employee newEmployee = new com.restapi.app.model.Employee(5l, "Amit", "active");
  ...
  public void testPut() {
    ...
    ResponseEntity<com.restapi.app.model.Employee> responseEntity = restClient.put()
        .uri("/employees/1")
        .contentType(MediaType.APPLICATION_JSON)
        .accept(MediaType.APPLICATION_JSON)
        .body(employee)
        .retrieve()
        .toEntity(com.restapi.app.model.Employee.class);
  ...
  public void testExchangeMethod() {
    ...
    List<com.restapi.app.model.Employee> list = restClient.get()
        .uri("/employees")
        .accept(MediaType.APPLICATION_JSON)
